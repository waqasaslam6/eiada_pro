...
class CompletedReservation extends StatefulWidget {
  @override
  _CompletedReservationState createState() => _CompletedReservationState();
}

class _CompletedReservationState extends State<CompletedReservation> {
  @override
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => InProgressReservation()));
                    },
                    child: Text(
